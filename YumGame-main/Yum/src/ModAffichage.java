package src;
/*
 * Regroupe toutes les procédures d'affichage du jeu de YUM.
 * 
 * L'affichage est en mode console.  
 * 
 * Le module connait le jeu, il sert à afficher la feuille de pointage et les dés
 * 
 * L'affichage des coups possibles doit être écrit dans le même fichier que
 * votre main().  
 * 
 * Ne touchez pas à ce module.
 * 
...
public class ModAffichage {
	...
	/*
	 * Affiche toutes les cases différentes de 0 de la grille reçue avec
     ...
     *
     * grille : Un tableau de NB_CASES à afficher.

	*****************************************/
	public static void afficherGrille(int grille[]){
		
		/*
		 * Des appels sont écrits sur 2 lignes pour respecter les 80 colonnes.
		 * 
		 * Un seul sous-programme utilisé qui affiche une ligne en 2 colonnes.
		 */
	    System.out.printf("\n                   GRILLE DE POINTAGE");
	 ...
	 */
	private static void afficherLigne(String titre1,
			                          String titre2,
			                          int val1,
			                          int val2){
	 ...
	 */
	private static void afficherColonne(String titre, int val) {
	...
	/*
	* Affiche graphiquement un dés représentant la valeur recue.
	*
	* des : un tableau de NB_DES chiffres entre 1 et NB_FACES 
	*                     représentant la valeur des dés à afficher.
	*                     	
	*Algorithme original : Karen DC (février 2005)
	*Adaptation     : Pierre Bélisle
	*/
	public static void afficherDes(int des[]){
		
		/*
		 * Stratégie : On affiche une ligne à la fois sachant que 
		 * les possibilités sur un dé NB_FACES (hard coded).
		 * 
		 * Si la constante change, il faut venir ajouter des lignes et changer
		 * le détails des prochaines procédures d'affichage.
		 */
	...
	private static void afficherPremiereLigne(){
	...
	private static void afficherDeuxiemeLigne(int des[]){
	...
	private static void afficherTroisiemeLigne(int des[]){
	...
	private static void afficherQuatriemeLigne(int des[]){
	...
	/*
	 * Affiche l'état d'arrêt d'une partie.
	 */
